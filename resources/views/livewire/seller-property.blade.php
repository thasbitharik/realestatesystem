<div>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-info text-white-all">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i>Seller Property</li>
        </ol>
    </nav>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover" id="tableExport">
                            ...
                            <tr>
                                <td>{{ $x }}</td>
                                <td><img alt="image" src="{{ Storage::url($row->image) }}" width="150px" height="150px "></td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Property Name" required="" wire:model="new_property">
                                    @error('new_property')
                                    <span class="text-danger text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Location" wire:model="new_location">
                                    @error('new_location')
                                    <span class="text-danger text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                                    <label>Price</label>
                                    <input type="text" class="form-control" placeholder="Price" wire:model="new_price">
                                    @error('new_price')
                                    <span class="text-danger text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12 col-sm-12 ">
                                    <div class="form-group">
                                        <label>Images</label>
                                        <input type="file" class="form-control" wire:model="new_image" placeholder="Images">
                                        @error('new_image')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
