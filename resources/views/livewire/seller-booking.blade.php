<div>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-info text-white-all">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i>Property Bookings</li>
        </ol>
    </nav>
                        ...
                        <table class="table table-striped table-hover" id="tableExport">
                            ...
                            @foreach ($list_data as $row)
                                <tr>
                                    ...
                                    <td>
                                        @if ($row->contract_plan == 1)
                                            5 Years
                                        @elseif ($row->contract_plan == 2)
                                            10 Years
                                        @elseif($row->contract_plan == 3)
                                            15 Years
